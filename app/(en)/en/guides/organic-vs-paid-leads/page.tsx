...
export const metadata: Metadata = {
  ...
  keywords: g.keywords,
  alternates: { canonical: URL, languages: { "he-IL": `${SITE.url}/guides/organic-vs-paid-leads`, "en-US": URL, "x-default": `${SITE.url}/guides/organic-vs-paid-leads` } },
...
export default function Page() {
  return <GuideLayoutEn slug={SLUG} blocks={BLOCKS} faq={FAQ} related={["google-vs-facebook-leads", "facebook-lead-ads-vs-groups", "facebook-group-leads", "hot-vs-cold-leads"]} />;
}
