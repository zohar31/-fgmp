...
export const metadata: Metadata = {
  ...
  keywords: g.keywords,
  alternates: { canonical: URL, languages: { "he-IL": `${SITE.url}/guides/best-facebook-groups-for-leads`, "en-US": URL, "x-default": `${SITE.url}/guides/best-facebook-groups-for-leads` } },
