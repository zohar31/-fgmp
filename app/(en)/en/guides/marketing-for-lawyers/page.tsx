...
export const metadata: Metadata = {
  ...
  keywords: g.keywords,
  alternates: { canonical: URL, languages: { "he-IL": `${SITE.url}/guides/marketing-for-lawyers`, "en-US": URL, "x-default": `${SITE.url}/guides/marketing-for-lawyers` } },
...
export default function Page() {
  return <GuideLayoutEn slug={SLUG} blocks={BLOCKS} faq={FAQ} related={["google-business-profile", "real-estate-leads", "speed-to-lead"]} />;
}
