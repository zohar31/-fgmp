...
export const metadata: Metadata = {
  ...
  keywords: g.keywords,
  alternates: { canonical: URL, languages: { "he-IL": `${SITE.url}/guides/marketing-for-social-media-managers`, "en-US": URL, "x-default": `${SITE.url}/guides/marketing-for-social-media-managers` } },
