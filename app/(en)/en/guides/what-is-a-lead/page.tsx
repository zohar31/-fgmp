...
export const metadata: Metadata = {
  ...
  keywords: g.keywords,
  alternates: { canonical: URL, languages: { "he-IL": `${SITE.url}/guides/what-is-a-lead`, "en-US": URL, "x-default": `${SITE.url}/guides/what-is-a-lead` } },
...
export default function Page() {
  return <GuideLayoutEn slug={SLUG} blocks={BLOCKS} faq={FAQ} related={["hot-vs-cold-leads", "lead-funnel", "lead-kpis"]} />;
}
