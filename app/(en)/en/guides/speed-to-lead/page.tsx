...
export const metadata: Metadata = {
  ...
  keywords: g.keywords,
  alternates: { canonical: URL, languages: { "he-IL": `${SITE.url}/guides/speed-to-lead`, "en-US": URL, "x-default": `${SITE.url}/guides/speed-to-lead` } },
...
export default function Page() {
  return <GuideLayoutEn slug={SLUG} blocks={BLOCKS} faq={FAQ} related={["hot-vs-cold-leads", "close-deal-over-text", "what-is-a-lead"]} />;
}
