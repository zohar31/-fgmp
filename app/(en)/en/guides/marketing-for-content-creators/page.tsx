...
export const metadata: Metadata = {
  ...
  keywords: g.keywords,
  alternates: { canonical: URL, languages: { "he-IL": `${SITE.url}/guides/marketing-for-content-creators`, "en-US": URL, "x-default": `${SITE.url}/guides/marketing-for-content-creators` } },
...
export default function Page() {
  return <GuideLayoutEn slug={SLUG} blocks={BLOCKS} faq={FAQ} related={["marketing-for-social-media-managers", "marketing-for-salons", "first-customers-new-business"]} />;
}
