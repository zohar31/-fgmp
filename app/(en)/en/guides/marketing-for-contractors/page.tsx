...
export const metadata: Metadata = {
  ...
  keywords: g.keywords,
  alternates: { canonical: URL, languages: { "he-IL": `${SITE.url}/guides/marketing-for-contractors`, "en-US": URL, "x-default": `${SITE.url}/guides/marketing-for-contractors` } },
...
export default function Page() {
  return <GuideLayoutEn slug={SLUG} blocks={BLOCKS} faq={FAQ} related={["house-cleaning-leads", "google-business-profile", "painter-leads"]} />;
}
