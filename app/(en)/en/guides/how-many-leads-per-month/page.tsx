...
export const metadata: Metadata = {
  ...
  keywords: g.keywords,
  alternates: { canonical: URL, languages: { "he-IL": `${SITE.url}/guides/how-many-leads-per-month`, "en-US": URL, "x-default": `${SITE.url}/guides/how-many-leads-per-month` } },
...
export default function Page() {
  return <GuideLayoutEn slug={SLUG} blocks={BLOCKS} faq={FAQ} related={["leads-for-small-business", "lead-sources", "quality-leads", "speed-to-lead"]} />;
}
