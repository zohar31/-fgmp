...
export const metadata: Metadata = {
  ...
  keywords: g.keywords,
  alternates: { canonical: URL, languages: { "he-IL": `${SITE.url}/guides/lead-handling-mistakes`, "en-US": URL, "x-default": `${SITE.url}/guides/lead-handling-mistakes` } },
...
export default function Page() {
  return <GuideLayoutEn slug={SLUG} blocks={BLOCKS} faq={FAQ} related={["lead-management-system", "speed-to-lead", "follow-up-cold-leads", "first-message-to-lead"]} />;
}
