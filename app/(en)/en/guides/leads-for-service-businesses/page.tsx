...
export const metadata: Metadata = {
  ...
  keywords: g.keywords,
  alternates: { canonical: URL, languages: { "he-IL": `${SITE.url}/guides/leads-for-service-businesses`, "en-US": URL, "x-default": `${SITE.url}/guides/leads-for-service-businesses` } },
...
export default function Page() {
  return <GuideLayoutEn slug={SLUG} blocks={BLOCKS} faq={FAQ} related={["marketing-for-influencers", "facebook-group-leads", "google-business-profile", "speed-to-lead"]} />;
}
