...
export const metadata: Metadata = {
  ...
  keywords: g.keywords,
  alternates: { canonical: URL, languages: { "he-IL": `${SITE.url}/guides/first-customers-new-business`, "en-US": URL, "x-default": `${SITE.url}/guides/first-customers-new-business` } },
