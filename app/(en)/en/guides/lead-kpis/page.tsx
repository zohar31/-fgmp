...
export const metadata: Metadata = {
  ...
  keywords: g.keywords,
  alternates: { canonical: URL, languages: { "he-IL": `${SITE.url}/guides/lead-kpis`, "en-US": URL, "x-default": `${SITE.url}/guides/lead-kpis` } },
...
export default function Page() {
  return <GuideLayoutEn slug={SLUG} blocks={BLOCKS} faq={FAQ} related={["lead-funnel", "cost-per-lead", "speed-to-lead", "how-many-leads-per-month"]} />;
}
