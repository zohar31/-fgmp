...
export const metadata: Metadata = {
  ...
  keywords: g.keywords,
  alternates: { canonical: URL, languages: { "he-IL": `${SITE.url}/guides/follow-up-cold-leads`, "en-US": URL, "x-default": `${SITE.url}/guides/follow-up-cold-leads` } },
...
export default function Page() {
  return <GuideLayoutEn slug={SLUG} blocks={BLOCKS} faq={FAQ} related={["whatsapp-business-setup", "speed-to-lead", "lead-automation"]} />;
}
