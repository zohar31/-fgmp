...
export default function Page() {
  return <GuideLayoutEn slug={SLUG} blocks={BLOCKS} faq={FAQ} related={["leads-from-telegram", "real-time-leads", "post-in-facebook-groups-without-getting-banned", "hot-vs-cold-leads"]} />;
}
