...
export const metadata: Metadata = {
  ...
  keywords: g.keywords,
  alternates: { canonical: URL, languages: { "he-IL": `${SITE.url}/guides/first-message-to-lead`, "en-US": URL, "x-default": `${SITE.url}/guides/first-message-to-lead` } },
...
export default function Page() {
  return <GuideLayoutEn slug={SLUG} blocks={BLOCKS} faq={FAQ} related={["lead-handling-mistakes", "lead-management-system", "hot-vs-cold-leads"]} />;
}
