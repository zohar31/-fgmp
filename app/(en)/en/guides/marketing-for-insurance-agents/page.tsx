...
export const metadata: Metadata = {
  ...
  keywords: g.keywords,
  alternates: { canonical: URL, languages: { "he-IL": `${SITE.url}/guides/marketing-for-insurance-agents`, "en-US": URL, "x-default": `${SITE.url}/guides/marketing-for-insurance-agents` } },
...
export default function Page() {
  return <GuideLayoutEn slug={SLUG} blocks={BLOCKS} faq={FAQ} related={["marketing-for-lawyers", "speed-to-lead", "follow-up-cold-leads", "leads-for-service-businesses"]} />;
}
