...
export const metadata: Metadata = {
  ...
  keywords: g.keywords,
  alternates: { canonical: URL, languages: { "he-IL": `${SITE.url}/guides/real-time-leads`, "en-US": URL, "x-default": `${SITE.url}/guides/real-time-leads` } },
...
export default function Page() {
  return <GuideLayoutEn slug={SLUG} blocks={BLOCKS} faq={FAQ} related={["leads-from-telegram", "quality-leads", "facebook-group-leads"]} />;
}
