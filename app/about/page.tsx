      ...
      <main id="main-content" className="container-x py-10 md:py-16">
        ...
        <article className="mx-auto mt-8 max-w-3xl">
          ...
          <div className="prose prose-invert prose-lg mt-12 max-w-none">
            ...
            <p>
              <strong>צח אור</strong> (FGMP · צח אור) — יזם ישראלי
            ...
            <ul>
              ...
              <li>
                <strong>תגובה מוצעת לכל פוסט — ערוכה ע״י AI</strong> — לכל ליד מצורף טקסט
                תגובה שנכתב ע״י AI ספציפית לפוסט הזה (לא תבנית קבועה). ה-AI מתאים את
                התגובה לתוכן הפוסט המסוים, לתחום העסק, ולסגנון — מקצר את הזמן שבין קבלת
                ליד לתגובה למשפט אחד: העתק, הדבק, שלח.
              </li>
              <li>
