...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${SITE.url}/guides/${SLUG}`, languages: { "he-IL": `${SITE.url}/guides/lead-handling-mistakes`, "en-US": `${SITE.url}/en/guides/lead-handling-mistakes`, "x-default": `${SITE.url}/guides/lead-handling-mistakes` } },
  openGraph: {
    type: "article",
    title: guide.title,
    description: guide.description,
    ...
    <>
      ...
      <main id="main-content" className="container-x py-10 md:py-16">
        ...
        <article className="mx-auto mt-8 max-w-3xl">
          ...
          <RelatedGuides
            currentSlug={SLUG}
            related={["lead-management-system", "speed-to-lead", "follow-up-cold-leads", "manage-leads-whatsapp"]}
          />
