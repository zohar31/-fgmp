...
// שורת מחירון: [תחום, טווח שוק ₪ לליד]. מסודר לפי קבוצות: בעלי מקצוע,
// אירועים ויופי, שירותים מקצועיים, פיננסים ואשראי, מימוש זכויות.
const PRICE_ROWS: [string, string][] = [
  ...
  ["הנדימן", "30-90"],
  ["מנעולן", "20-60"],
  ["מיזוג אוויר / טכנאי מזגנים", "80-200"],
  ["צביעת דירות", "37-74"],
  ["נגרות", "53-120"],
  ["איטום גגות", "20-90"],
  ...
  ["איתור נזילות", "20-60"],
  ["הובלות", "20-75"],
  ["התקנת מצלמות אבטחה", "50-120"],
  ["טכנאי מחשבים", "30-74"],
  ["מוסך / תיקוני רכב", "30-90"],
  ["עוזרת בית / ניקיון", "20-60"],
  // אירועים, יופי ובריאות
  ["צילום אירועים", "53-105"],
  ["צילום וידאו", "53-126"],
  ["איפור / מאפרת", "20-95"],
  ["קונדיטוריה ועוגות", "30-84"],
  ["קייטרינג", "84-126"],
  ["תקליטנים (DJ)", "30-80"],
  ["קוסמטיקאיות", "20-70"],
  ["אסתטיקה (בוטוקס, חומצה)", "32-126"],
  ["הסרת שיער בלייזר", "32-74"],
  ["מספרה / עיצוב שיער", "20-70"],
  ["מניקור פדיקור", "20-70"],
  ["רופאי שיניים", "30-126"],
  ["דיאטנית / תזונה", "42-95"],
  ["וטרינר", "30-90"],
  ["מאלף כלבים", "30-80"],
  ["מאמן כושר", "20-60"],
  ["מטפלת קשישים / סיעוד", "40-100"],
  ["בייביסיטר", "20-50"],
  ["מורה פרטי / שיעורים פרטיים", "20-60"],
  ["מורה יוגה", "20-70"],
  ["מורי נהיגה", "20-50"],
  // שירותים מקצועיים
  ["עורכי דין", "40-100"],
  ...
  ["בניית אתרים", "84-158"],
  ["עיצוב פנים", "53-84"],
  ["מתווך נדל\"ן / נדל\"ן", "84-158"],
  // פיננסים ואשראי
  ["ביטוח (כללי)", "42-110"],
  ["ביטוח בריאות / חיים", "85-110"],
  ["משכנתאות", "53-98"],
  ["מחזור משכנתא", "50-100"],
  ["פנסיה ותכנון פרישה", "85-120"],
  ["ייעוץ פיננסי", "40-120"],
  ["הלוואות", "20-95"],
  ["הלוואות לעסקים", "53-120"],
  ["הלוואה כנגד נכס", "80-115"],
        ...
        <article className="mx-auto mt-8 max-w-3xl">
          ...
          <div className="prose prose-invert prose-lg mt-10 max-w-none">
            ...
            <p>
              ...
              ב-{SITE.pricing.refundDays} הימים הראשונים לא קיבלת לידים אמיתיים בתחום שלך — מקבלים את הכסף בחזרה, בלי שאלות.
            </p>
          </div>
