...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${SITE.url}/guides/${SLUG}`, languages: { "he-IL": `${SITE.url}/guides/exclusive-vs-shared-leads`, "en-US": `${SITE.url}/en/guides/exclusive-vs-shared-leads`, "x-default": `${SITE.url}/guides/exclusive-vs-shared-leads` } },
  openGraph: {
    type: "article",
    title: guide.title,
    description: guide.description,
