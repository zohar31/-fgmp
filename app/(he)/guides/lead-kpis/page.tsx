...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${SITE.url}/guides/${SLUG}`, languages: { "he-IL": `${SITE.url}/guides/lead-kpis`, "en-US": `${SITE.url}/en/guides/lead-kpis`, "x-default": `${SITE.url}/guides/lead-kpis` } },
  openGraph: {
    type: "article",
    title: guide.title,
    description: guide.description,
    ...
    <>
      ...
      <main id="main-content" className="container-x py-10 md:py-16">
        ...
        <article className="mx-auto mt-8 max-w-3xl">
          ...
          <RelatedGuides
            currentSlug={SLUG}
            related={["calculate-cost-per-lead", "lead-strategy", "lead-funnel", "lead-cost-facebook-2026"]}
          />
