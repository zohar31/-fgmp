...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${SITE.url}/guides/${SLUG}`, languages: { "he-IL": `${SITE.url}/guides/lead-sources`, "en-US": `${SITE.url}/en/guides/lead-sources`, "x-default": `${SITE.url}/guides/lead-sources` } },
  openGraph: {
    type: "article",
    title: guide.title,
    description: guide.description,
