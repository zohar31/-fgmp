...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${SITE.url}/guides/${SLUG}`, languages: { "he-IL": `${SITE.url}/guides/leads-for-service-businesses`, "en-US": `${SITE.url}/en/guides/leads-for-service-businesses`, "x-default": `${SITE.url}/guides/leads-for-service-businesses` } },
  openGraph: {
    type: "article",
    title: guide.title,
    description: guide.description,
    ...
    <>
      ...
      <main id="main-content" className="container-x py-10 md:py-16">
        ...
        <article className="mx-auto mt-8 max-w-3xl">
          ...
          <RelatedGuides
            currentSlug={SLUG}
            related={["google-business-profile-guide", "leads-solari", "leads-from-facebook-groups", "speed-to-lead", "lead-sources"]}
          />
