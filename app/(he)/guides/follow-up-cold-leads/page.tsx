...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${SITE.url}/guides/${SLUG}`, languages: { "he-IL": `${SITE.url}/guides/follow-up-cold-leads`, "en-US": `${SITE.url}/en/guides/follow-up-cold-leads`, "x-default": `${SITE.url}/guides/follow-up-cold-leads` } },
  openGraph: {
    type: "article",
    title: guide.title,
    description: guide.description,
