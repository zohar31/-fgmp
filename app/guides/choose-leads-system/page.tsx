      ...
      <main id="main-content" className="container-x py-10 md:py-16">
        ...
        <article className="mx-auto mt-8 max-w-3xl">
          ...
          <div className="prose prose-invert prose-lg mt-12 max-w-none">
            ...
            <h3>6. הגנה על הלקוח — ערבות החזר?</h3>
            <p>
              ספק רציני נותן ערבות החזר אמיתית: אתה משלם, מקבל גישה מיידית לכל היכולות, ואם זה לא בשבילך —
              מקבל את הכסף בחזרה. ב-FGMP: ערבות החזר מלא {SITE.pricing.refundDays} ימים מהיום שהתחלת.
              לא מרוצה? בקשה דרך האזור האישי, האדמין מאשר ידנית, ההחזר חוזר לכרטיס שלך תוך מספר ימי עסקים.
            </p>
            ...
            <ol>
              ...
              <li>ביטול דרך אזור אישי, ללא טפסים?</li>
              <li>ערבות החזר מלא בימים הראשונים?</li>
            ...
            <p>
              FGMP עומד ב-9 הקריטריונים. אבל אל תאמין לנו — תנסה. {SITE.pricing.monthlyILS}₪/חודש,
              עם ערבות החזר מלא {SITE.pricing.refundDays} ימים. אם תרגיש שזה לא בשבילך —
              מבקש ביטול דרך האזור האישי, מקבל את כל ה-299 ₪ בחזרה. אפס סיכון.
            </p>
          </div>

          <div className="mt-14 rounded-3xl bg-gradient-to-br from-brand-500/15 to-wa/15 p-8 ring-1 ring-white/10 md:p-10">
            <h3 className="font-display text-2xl font-bold text-white">
              בדיקה אובייקטיבית = ערבות החזר {SITE.pricing.refundDays} ימים.
            </h3>
            <p className="mt-2 text-ink-200">
              {SITE.pricing.monthlyILS}₪ לחודש. {SITE.pricing.refundDays} ימי החזר מלא. תקבל לידים אמיתיים, תשפוט בעצמך.
            </p>
            <div className="mt-6">
