      ...
      <main id="main-content" className="container-x py-10 md:py-16">
        ...
        <article className="mx-auto mt-8 max-w-3xl">
          ...
          <div className="prose prose-invert prose-lg mt-12 max-w-none">
            ...
            <p>
              מערכת שמתחברת לפייסבוק שלך, סורקת אלפי קבוצות שאתה חבר בהן, מסננת באמצעות AI לפי תחום
              העיסוק שלך, ושולחת רק את הלידים הרלוונטיים — לוואטסאפ או טלגרם — תוך שניות מהפרסום.
            </p>
            <p>
            ...
            <p>
              תלוי בתחום, אזור גיאוגרפי, ומספר הקבוצות שאתה חבר בהן. נתונים מתוך מערכת FGMP (2026):
            </p>
            <ul>
            ...
            <h3>זה חוקי?</h3>
            <p>
              כן. אנחנו לא נכנסים לקבוצות סגורות בלי שהמנוי מצטרף, לא משתפים תכנים ללא רשות, ולא מבצעים
              פעולות אוטומטיות. המערכת רק מנתחת תוכן ציבורי שכבר נראה לחברי הקבוצות שאתה חבר בהן.
              לפרטי תקנון <Link href="/terms" className="text-brand-300 underline">כאן</Link>.
            </p>
