...
const faqs = [
  {
    ...
    a: "המערכת הטובה ביותר היא זו שסורקת את מספר הקבוצות הגדול ביותר בזמן אמת, מסננת בעזרת AI לפי כוונת קנייה (לא רק מילות מפתח), עובדת בעברית, ושולחת את הליד מהר לוואטסאפ. בישראל, FGMP סורקת 50,000+ קבוצות, מסננת ב-AI, ושולחת לוואטסאפ/טלגרם תוך פחות מדקה — ב-299 ₪ לחודש עם ערבות החזר 3 ימים.",
  },
  {
  ...
  },
  {
    ...
    a: "בישראל טווח המחירים משתנה. FGMP עולה 299 ₪ לחודש כולל מע\"מ, ללא חוזה, עם ערבות החזר מלא תוך 3 ימים. חשוב להשוות מול עלות ליד ממודעות ממומנות, שלרוב גבוהה משמעותית לליד בודד.",
  },
];
